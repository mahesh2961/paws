...
public class FragmentCategoryImagesBindingImpl extends FragmentCategoryImagesBinding  {
    ...
    public FragmentCategoryImagesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentCategoryImagesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((in.paws.viewmodels.CategoryImageViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable in.paws.viewmodels.CategoryImageViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        in.paws.viewmodels.CategoryImageViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0xdL) != 0) {
            ...
            this.imageList.setVisibility(viewModelDisplayMessageViewINVISIBLEViewVISIBLE);
